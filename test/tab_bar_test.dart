...
void main() {
  ...
  // Coverage: VBottomNavBar with enableLineIndicator: false
  testWidgets("VBottomNavBar enableLineIndicator false",
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        bottomNavigationBar: VBottomNavBar(
          visaBottomNavBarItems: [
            VBottomBarItems(icon: VIcons.homeLow, label: 'Home'),
            VBottomBarItems(icon: VIcons.searchLow, label: 'Search'),
          ],
          currentIndex: 0,
  ...
  // Coverage: VBottomNavBar item tap
  testWidgets("VBottomNavBar item onTap fires", (WidgetTester tester) async {
    int tappedIndex = -1;
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        bottomNavigationBar: VBottomNavBar(
